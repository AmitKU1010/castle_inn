...
@section('content')
  ...
  <section class="content">
    <div class="card">
      <div class="card-header">
        <h3 class="card-title pb-2">Product Type</h3>
          ...
          <thead>
            <tr>
              <th width="100px">#</th>
               ...
               <th>PRODUCT BRAND/DRINK TYPE</th>
  ...
  <div class="modal fade" id="ajaxModel" aria-hidden="true">
    <div class="modal-dialog">
     ...
     <select name="pd_catagory" id="pd_catagory" class="form-control">
       ...
       <option>DRINKS</option>
         ...
         <div class="form-group">
           ...
           <input type="text" class="form-control" name="item_category_name" id="item_category_name" placeholder="PRODUCT TYPE/BRAND"  autofocus="">
         </div>
         </div>
         ...
         <div class="form-group">
           <label>REMARKS</label>
           <input type="text" class="form-control" name="item_description" id="item_description" placeholder="PRODUCT DESCRIPTION"  autofocus="">
         </div>
         </div>
          </div>
    ...
    <script type="text/javascript">
      $(function() {
        ...
        var table = $('.data-table').DataTable({
          processing: true,
          serverSide: true,
          ajax: "{{ route('ajaxitem_catagories.index') }}",
          language: {
        ...
        $('body').on('click', '.editRecord', function() {
          ...
          $.get("{{ route('ajaxitem_catagories.index') }}" + '/' + _id + '/edit', function(data) {
        ...
        $('#saveBtn').click(function(e) {
          ...
          $.ajax({
            ...
            url: "{{ route('ajaxitem_catagories.store') }}",
            type: "POST",
            dataType: 'json',
        ...
        $('body').on('click', '.deleteRecord', function() {
          Swal.fire({
            ...
            if (result.value) {
              ...
              $.ajax({
                type: "DELETE",
                url: "{{ route('ajaxitem_catagories.store') }}" + '/' + _id,
                success: function(data) {
                  if (data.success) {
                    Toast.fire({
                      type: 'success',
