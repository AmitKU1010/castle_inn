...
@section('content')
  ...
  <div class="content-header">
    <div class="container-fluid">
      <div class="row mb-2">
        <div class="col-sm-6">
          <h1 class="m-0 text-dark">Central Stock</h1>
        </div>
        <div class="col-sm-6">
  ...
  <section class="content">
    <div class="card">
      <div class="card-header">
        <h3 class="card-title pb-2">Central Stocks</h3>
    ...
    <script type="text/javascript">
      $(function() {
        ...
        var table = $('.data-table').DataTable({
          processing: true,
          serverSide: true,
          ajax: "{{ route('ajaxcentralstock.index') }}",
          language: {
          ...
          columns: [{
            ...
            {data: 'pd_cat',name: 'pd_cat'},
            {data: 'item_type_name',name: 'item_type_name'},
            {data: 'item_name_real',name: 'item_name_real'},
            {data: 'real_drink_size',name: 'real_drink_size'},
            {data: 'real_stock_in',name: 'real_stock_in'},
            {data: 'real_stock_out',name: 'real_stock_out'},
            {data: 'stock_avail_real',name: 'stock_avail_real'},
