...
@section('content')
  ...
  <div class="content-header">
    <div class="container-fluid">
      <div class="row mb-2">
        <div class="col-sm-6">
          <h1 class="m0 text-dark">Purchase Product</h1>
        </div>
        <div class="col-sm-6">
  ...
  <section class="content">
    <div class="card">
      <div class="card-header">
        <h3 class="card-title pb-2">Purchase Product</h3>
      ...
      <div class="modal-content" style="width: 911px;right:72px;">
        ...
        <div class="row">
         ...
         <div class="form-group">
           ...
           <select class="form-control" name="supplier_name" id="supplier_name" style="color: black;">
         ...
         <div class="form-group">
           ...
           <input type="text" class="form-control" name="supplier_contact_no" id="supplier_contact_no" placeholder="supplier_contact_no"  autofocus="">
         </div>
         </div>
         ...
         <div class="form-group">
           ...
           <input type="text" class="form-control" name="supplier_address" id="supplier_address" placeholder="supplier_address"  autofocus="">
         </div>
         </div>
         ...
         <div class="form-group">
           ...
           <input type="email" class="form-control" name="supplier_email" id="supplier_email" placeholder="supplier_email"  autofocus="">
         </div>
         </div>
         ...
         <div class="form-group">
           ...
           <input type="text" class="form-control" name="purchase_invoice_number" id="purchase_invoice_number" placeholder="purchase_invoice_number"  autofocus="">
         </div>
         </div>
         ...
         <div class="form-group">
           ...
           <input type="date" class="form-control" name="purchase_invoice_date" id="purchase_invoice_date" placeholder="purchase_invoice_date"  autofocus="">
         </div>
         </div>
         ...
         <div class="form-group">
           ...
           <select class="form-control" name="payment_type" id="payment_type" style="color: black;">
             <option>By Cash</option>
             <option>By Card</option>
             <option>By Cheque</option>
             <option>By Internet Banking</option>
           </select>
         </div>
         </div>
         ...
         <div class="col-sm-3">
         <div class="form-group">
           <label>Purchase Description/Notes</label>
           <input type="text" class="form-control" name="purchase_discription" id="purchase_discription" placeholder="purchase_discription"  autofocus="">
         </div>
         </div>
        ...
        <div class="col-sm-12">  
         ...
         <td>
           ...
           <select class="form-control item_name_class" name="item_name[]" id="item_name-0" style="color: black;">
            ...
            <div class="form-group drink_size_div_class" id="drink_size_div-0" style="display: none;">
                ...
                <td></td>
                  ...
                  <tfoot >                    
                    <tr> 
                      ...
                      <td><input type="number" step="any" required  class="form-control form-control-rounded" name="total_purchase_amount" id="total_purchase_amount"></td>
                      <td></td>
                      <td></td>
      ...
      $(function() {
        ...
        var table = $('.data-table').DataTable({
          ...
          columns: [{
            ...
            {data:'real_supplier_name', name:'real_supplier_name'},
            {data:'real_supplier_contact', name:'real_supplier_contact'},
            {data:'supplier_gst',name:'supplier_gst'},
            {data:'real_purchase_date', name:'real_purchase_date'},
            {data:'real_total_purchase_amount',name:'real_total_purchase_amount'},
...
// alert('1');
  ...
  $.ajax({
        ...
        success: function(data){
          ...
          console.log(data);
          $('#supplier_contact_no').val(responseData.contact_no);
           $('#supplier_address').val(responseData.address);  
           $('#supplier_email').val(responseData.email);  
           $('#gstin').val(responseData.gstin);  
        }
      });
});
...
\
            <div class="form-group drink_size_div_class" id="drink_size_div-'+i+'" style="display: none;">\
           <label>Drink Size</label>\
...
{ 
  ...
  $('.drink_size_div_class').show();
}
else
{
  $('.drink_size_div_class').hide();
