...
@section('content')
  <div class="content-header">
    <div class="container-fluid">
      <div class="row mb-2">
        <div class="col-sm-6">
          <h1 class="m-0 text-dark">Counter Sale</h1>
        </div>
        <div class="col-sm-6">
  ...
  <section class="content">
    <div class="card">
      <div class="card-header">
        <h3 class="card-title pb-2">Counter Sale</h3>
      ...
      <div class="modal-content" style="width: 911px;right:72px;">
        ...
        <div class="row">
         ...
         <label>Customer Name.</label>
           <input type="text" class="form-control" name="customer_name" id="customer_name" placeholder="customer name"  autofocus="">
         </div>
         </div>
         ...
         <div class="form-group">
           ...
           <input type="text" class="form-control" name="customer_address" id="customer_address" placeholder="address"  autofocus="">
         </div>
         </div>
         ...
         <div class="form-group">
           ...
           <input type="text" class="form-control" name="customer_number" id="customer_number" placeholder="contact_number"  autofocus="">
         </div>
         </div>
         ...
         <div class="form-group">
           ...
           <input type="date" class="form-control" name="customer_invoice_date" id="customer_invoice_date" placeholder="Bill Date"  autofocus="">
         </div>
         </div>
         ...
         <div class="form-group">
           ...
           <input type="text" class="form-control" name="customer_invoice_number" id="issue_customer_invoice_number" placeholder="invoice_number"  autofocus="">
         </div>
         </div>
        ...
        <div class="col-sm-12">  
         ...
         <td>
           ...
           <select class="form-control item_name_class" name="item_name[]" id="item_name-0" style="color: black;">
            ...
            <div class="form-group drink_class" id="drink_size_div-0" style="display: none;">
                ...
                <td></td>
                  ...
                  <tfoot >                    
                    <tr> 
                      ...
                      <td><input type="number" step="any" required  class="form-control form-control-rounded" name="total_quantity_use" id="total_quantity_use"></td>
                      <td></td>
                      <td></td>
    ...
    <script type="text/javascript">
      $(function() {
        ...
        var table = $('.data-table').DataTable({
          processing: true,
          serverSide: true,
          ajax: "{{ route('ajax_counter_sale.index') }}",
          language: {
          ...
          columns: [{
            ...
            {data:'customer_invoice_date', name:'customer_invoice_date'},
            {data:'total_quantity_use', name:'total_quantity_use'},
        ...
        $('#saveBtn').click(function(e) {
          ...
          $.ajax({
            ...
            url: "{{ route('ajax_counter_sale.store') }}",
            type: "POST",
            dataType: 'json',
...
\
            <div class="form-group drink_class" id="drink_size_div-'+i+'" style="display: none;">\
           <label>Drink Size</label>\
...
$('#total_amount-'+split_id_for_allrows[1]).val(total_amount);
 ...
 setInterval(function(){
     ...
     $("[name^='total_amount']")
              ...
              if(!isNaN(Total))
              {
                 $('[name=total_quantity_use]').val(Total);
              } 
