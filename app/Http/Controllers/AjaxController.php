...
class AjaxController extends Controller
{
    ...
    {
            $supplier= Supplier::where('id',$request->supplier_name)->first()->toArray();
    ...
    public function getItemCatagory(Request $request)
    {
        ...
        // exit;
        $itemName= ItemKot::where('item_type_id_kots',$request->item_catagory)->get();
        return json_encode($itemName);
    }

 
     public function get_pdcat(Request $request)
    {
        // echo $request->item_catagory;
        // exit;
        $itemName= itemCatagory::where('pd_catagory',$request->pd_cat)->get();
        return json_encode($itemName);
     ...
     public function getitemNameById(Request $request)
    {
        // echo $request->item_catagory;
        // exit;
        $itemName= itemName::where('item_catagories_id',$request->item_cat_name)->get();
        return json_encode($itemName);
    ...
    {
         // echo $request->item_catagory_value;
        // exit;

        $itemName= itemName::where([
    ['pd_catagory', '=', $request->pd_cat_value],['item_catagories_id', '=', $request->item_catagory_value],
    ['id', '=', $request->item_name_value],
])->get();
       ...
       public function getDrinkDetailsById(Request $request)
    {
         // echo $request->item_catagory_value;
        // exit;
  ...
  public function getPriceOfNib(Request $request)
     {
        
         $itemName= ItemKot::where([
    ['item_type_id_kots', '=', $request->drink_type],
    ['id', '=', $request->drink_name]])->first()->toArray();
    ...
    public function getItemNameByCategory(Request $request)
    {
     ...
     public function getCustomerDetailById(Request $request)
     {
         ...
         $customer= Customer::where('id',$request->customer_name)->first()->toArray();
     ...
     public function getproductDetailById(Request $request)
     {
         ...
         $itemName= itemName::where('id',$request->item_name)->first()->toArray();
         return json_encode($itemName);
     }
 ...
 public function getBranchByID(Request $request)
    {
        // echo $request->item_catagory;
        // exit;
        $branch= Branch::where('user_id',$request->branch)->get();
